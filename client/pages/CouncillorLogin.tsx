...
export default function CouncillorLogin() {
  ...
  const handleSubmit = async (e: any) => {
    ...
    try {
      ...
      localStorage.setItem('role', 'councillor');
    ...
    <div className="min-h-screen bg-gradient-to-br from-emerald-50 via-white to-emerald-50 flex items-center justify-center px-4">
      ...
      <div className="absolute top-4 right-4 flex items-center gap-2">
        ...
        <select
          ...
          className="px-3 py-2 border border-gray-300 rounded-lg bg-white text-sm font-medium text-gray-700 hover:border-gray-400 focus:outline-none focus:ring-2 focus:ring-emerald-500"
        >
      ...
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          <div className="inline-block bg-emerald-600 p-4 rounded-full mb-4">
            <User className="w-8 h-8 text-white" />
          </div>
          <h1 className="text-3xl font-bold text-gray-900 mb-2">{t('councillorLogin')}</h1>
          <p className="text-gray-600">{t('wardCouncillor')}</p>
        </div>
        ...
        <div className="bg-white rounded-xl shadow-lg p-8 mb-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-emerald-600 text-white font-semibold py-2 rounded-lg hover:bg-emerald-700 transition-colors disabled:opacity-50"
            >
